...
test('publish-docker supports workflow_call and is wired from release workflow', async () => {
  ...
  assert.match(release, /publish_docker:[\s\S]*?needs:\s*\[plan, bump_versions_dev, promote_preview, promote_main, bind_server_source, verify_release_candidates, publish_cli_binaries, publish_server_runtime, promote_cli_binaries, promote_server_runtime, promote_ui_web\]/);
