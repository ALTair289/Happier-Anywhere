...
4. **Re-measure every number.** Line counts, test results, coverage, timings — rerun at the exact recorded commit/basis, not the current tree, and attribute any difference to concurrent churn explicitly. This repo's history includes lanes reporting suites green that were red at their own commit, and inflated LOC deltas. Not malice; drift.
