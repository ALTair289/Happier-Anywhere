---
name: handoff-report
description: Output contract for substantive deliverables — outcome first, evidence-pointed reasoning, observed/derived/assumed labels, residual risk last, failures never buried. Use when reporting completed work, findings, diagnoses, reviews, or lane results.
---
