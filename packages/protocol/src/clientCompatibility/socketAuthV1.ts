...
export const ClientCompatibilitySocketAuthV1Schema = z
  .object({
...
export function buildClientCompatibilitySocketAuthV1(
...
export function parseClientCompatibilitySocketAuthV1(
  ...
  return { status: 'valid', declaration: parsed.data.clientCompatibility };
}
