...
export const pl: TranslationStructure = {
  ...
  status: {
    ...
    backgroundActive: "zadania w tle działają",
  ...
  connect: {
    ...
    pairingCompatibleModeTitle: "Parowanie zgodne",
    pairingCompatibleModeBody: "Działa z obecną i starszymi aplikacjami Happier. To tryb domyślny.",
    pairingSecureModeTitle: "Bezpieczne parowanie claim-v1",
    pairingSecureModeBody: "Wymaga aplikacji obsługującej claim-v1. Ten tryb nigdy nie przełącza się po cichu.",
    generateSecureQrCode: "Wygeneruj bezpieczny QR",
                    ...
                    claudeUnifiedTerminalWorkspaceTrust: {
                        ...
                        options: {
                            ...
                            always_trust_happier_workspaces: {
                                ...
                                subtitle: "Zaakceptuj bieżące ponownie przechwycone pytanie Claude'a dla obszarów roboczych otwartych przez Happier."
                            },
                            always_reject_happier_workspaces: {
                                title: "Zawsze odrzucaj obszary robocze Happier",
                                subtitle: "Odrzuć bieżące ponownie przechwycone pytanie Claude'a dla obszarów roboczych otwartych przez Happier."
                            }
                        }
                    },
