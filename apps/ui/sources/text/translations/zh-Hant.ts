      ...
      session: {
          ...
          workflow: {
            ...
            goal: {
              ...
              pending: '正在設定目標…',
              pendingTimeout: '無法確認目標更新，可能仍在套用中。',
          ...
          actionsDraft: {
            ...
            pendingMessages: {
                ...
                deliveryBlockedReasons: {
                    ...
                    providerAcceptanceTimeout: '提供者未確認接收',
...
settingsSession: {
	          sessionList: {
	              ...
	              separateBackgroundWorkTitle: '分開背景工作',
	              separateBackgroundWorkEnabledSubtitle: '將即時背景工作顯示在自己的分組中',
	              separateBackgroundWorkDisabledSubtitle: '將即時背景工作合併到正在工作',
