  ...
  settingsKeyboard: {
    ...
    connectedServices: {
        ...
        quota: {
            ...
            recoveryCreditNothingToReset: '目前沒有已耗盡的用量視窗需要重設。',
    ...
    connect: {
        ...
        pairingCompatibleModeTitle: '相容配對',
        pairingCompatibleModeBody: '適用於目前及舊版 Happier 手機應用程式。這是預設模式。',
        pairingSecureModeTitle: '安全 claim-v1 配對',
        pairingSecureModeBody: '需要支援 claim-v1 的手機應用程式，且此模式絕不會靜默降級。',
        generateSecureQrCode: '產生安全 QR 碼',
                ...
                fields: {
                    ...
                    claudeUnifiedTerminalWorkspaceTrust: {
                        ...
                        options: {
                            ask_every_time: {
                                title: "每次詢問",
                                subtitle: "在工作階段中顯示原始的工作區信任問題。"
                            },
                            always_trust_happier_workspaces: {
                                title: "一律信任 Happier 工作區",
                                subtitle: "對 Happier 開啟的工作區，信任目前重新擷取的 Claude 提示。"
                            },
                            always_reject_happier_workspaces: {
                                title: "一律拒絕 Happier 工作區",
                                subtitle: "對 Happier 開啟的工作區，拒絕目前重新擷取的 Claude 提示。"
                            }
                        }
                    },
