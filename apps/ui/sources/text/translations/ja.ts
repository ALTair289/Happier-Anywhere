...
export const ja: TranslationStructure = {
  ...
  connect: {
    ...
    pairingCompatibleModeTitle: "互換ペアリング",
    pairingCompatibleModeBody: "現在および旧バージョンの Happier モバイルアプリで利用できます。これが既定です。",
    pairingSecureModeTitle: "安全な claim-v1 ペアリング",
    pairingSecureModeBody: "claim-v1 対応アプリが必要です。このモードは暗黙にフォールバックしません。",
    generateSecureQrCode: "安全なQRコードを生成",
...
localTailscale: {
  ...
  connectedServices: {
    ...
    quota: {
      ...
      recoveryCreditNothingToReset: "現在、リセットが必要な使用量上限はありません。",
            ...
            claude: {
                ...
                fields: {
                    ...
                    claudeUnifiedTerminalWorkspaceTrust: {
                        title: "ワークスペースの信頼",
                        subtitle: "Claude がワークスペースを信頼するか尋ねたときに、Happier がどう応答するかを選択します。",
                        options: {
                            ask_every_time: {
                                title: "毎回確認する",
                                subtitle: "ワークスペースを信頼するかという質問をそのままセッションに表示します。"
                            },
                            always_trust_happier_workspaces: {
                                title: "Happier のワークスペースを常に信頼する",
                                subtitle: "Happier が開いたワークスペースについて、再取得した現在の Claude のプロンプトを信頼します。"
                            },
                            always_reject_happier_workspaces: {
                                title: "Happier のワークスペースを常に拒否する",
                                subtitle: "Happier が開いたワークスペースについて、再取得した現在の Claude のプロンプトを拒否します。"
                            }
                        }
                    },
