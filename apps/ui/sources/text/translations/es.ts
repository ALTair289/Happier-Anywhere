...
export const es: TranslationStructure = {
  ...
  connect: {
    ...
    pairingCompatibleModeTitle: "Emparejamiento compatible",
    pairingCompatibleModeBody: "Funciona con las aplicaciones móviles Happier actuales y antiguas. Es el modo predeterminado.",
    pairingSecureModeTitle: "Emparejamiento seguro claim-v1",
    pairingSecureModeBody: "Requiere una aplicación compatible con claim-v1. Este modo nunca cambia silenciosamente.",
    generateSecureQrCode: "Generar QR seguro",
  ...
  connectedServices: {
    ...
    quota: {
      ...
      recoveryCreditNothingToReset: "Ninguna ventana de uso agotada necesita restablecerse en este momento.",
                    ...
                    claudeUnifiedTerminalWorkspaceTrust: {
                        ...
                        options: {
                            ...
                            always_trust_happier_workspaces: {
                                ...
                                subtitle: "Acepta la solicitud actual de Claude, recapturada para los espacios de trabajo abiertos por Happier."
                            },
                            always_reject_happier_workspaces: {
                                title: "Rechazar siempre los espacios de trabajo de Happier",
                                subtitle: "Rechaza la solicitud actual de Claude, recapturada para los espacios de trabajo abiertos por Happier."
                            }
                        }
                    },
