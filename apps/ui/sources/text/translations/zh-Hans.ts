...
export const zhHans: TranslationStructure = {
  ...
  connect: {
    ...
    pairingCompatibleModeTitle: "兼容配对",
    pairingCompatibleModeBody: "适用于当前及旧版 Happier 手机应用。这是默认模式。",
    pairingSecureModeTitle: "安全 claim-v1 配对",
    pairingSecureModeBody: "需要支持 claim-v1 的手机应用，且此模式绝不会静默降级。",
    generateSecureQrCode: "生成安全二维码",
  ...
  connectedServices: {
    ...
    quota: {
      ...
      recoveryCreditNothingToReset: "当前没有耗尽的用量窗口需要重置。",
                ...
                fields: {
                    ...
                    claudeUnifiedTerminalWorkspaceTrust: {
                        ...
                        options: {
                            ask_every_time: {
                                title: "每次询问",
                                subtitle: "在会话中显示原始的工作区信任问题。"
                            },
                            always_trust_happier_workspaces: {
                                title: "始终信任 Happier 工作区",
                                subtitle: "对 Happier 打开的工作区，信任当前重新捕获的 Claude 提示。"
                            },
                            always_reject_happier_workspaces: {
                                title: "始终拒绝 Happier 工作区",
                                subtitle: "对 Happier 打开的工作区，拒绝当前重新捕获的 Claude 提示。"
                            }
                        }
                    },
