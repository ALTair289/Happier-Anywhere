...
export const pt: TranslationStructure = {
  ...
  connect: {
    ...
    pairingCompatibleModeTitle: "Emparelhamento compatível",
    pairingCompatibleModeBody: "Funciona com apps Happier atuais e antigos. Este é o modo padrão.",
    pairingSecureModeTitle: "Emparelhamento seguro claim-v1",
    pairingSecureModeBody: "Requer um app compatível com claim-v1. Este modo nunca regride silenciosamente.",
    generateSecureQrCode: "Gerar QR seguro",
