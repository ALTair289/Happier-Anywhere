...
export const en = {
    ...
    connect: {
        ...
        pairingCompatibleModeTitle: 'Compatible pairing',
        pairingCompatibleModeBody: 'Works with current and older Happier phone apps. This is the default.',
        pairingSecureModeTitle: 'Secure claim-v1 pairing',
        pairingSecureModeBody: 'Requires a phone app that supports claim-v1. This mode never silently falls back.',
        generateSecureQrCode: 'Generate secure QR',
