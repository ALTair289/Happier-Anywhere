...
describe('SessionWorkflowActivitySection', () => {
    ...
    let areSessionWorkflowRunPanelPropsEqual!: typeof import('./SessionWorkflowActivitySection').areSessionWorkflowRunPanelPropsEqual;

    beforeAll(async () => {
        ({ SessionWorkflowActivitySection, areSessionWorkflowRunPanelPropsEqual } = await import('./SessionWorkflowActivitySection'));
    }, 60_000);
