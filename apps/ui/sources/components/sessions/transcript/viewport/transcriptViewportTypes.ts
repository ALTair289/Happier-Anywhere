...
export type TranscriptViewportCommand =
    ...
    | Readonly<{ kind: 'preserve-live-tail-distance'; sessionId: string; reason: TranscriptViewportScrollReason; mode: 'follow-bottom'; previousDistanceFromLiveTailPx: number; animated?: boolean }>
