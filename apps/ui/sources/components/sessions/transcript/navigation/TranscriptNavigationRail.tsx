...
export function TranscriptNavigationRail(props: TranscriptNavigationRailProps) {
    ...
    const onJumpToEntry = props.onJumpToEntry;
    ...
    // Pointer type is deliberately NOT filtered: a touch tap must both reveal
    ...
    // Roving tabstop: the rail keeps DOM focus while the active descendant
